    ...
    while(query.next())
    {
        ...
        {   qDebug() << "label found "<<sLabel;
            if(query.value(1).toString().compare("N") == 0)
            {
                ...
                QPixmap pm ("C:/Users/hamza/Desktop/QT_Project_On_Movie_Ticket_Booking/img/reserved.png");
                ptr->setPixmap(pm);
            ...
            {
                QPixmap pm ("C:/Users/hamza/Desktop/QT_Project_On_Movie_Ticket_Booking/img/workplace.png");
                ptr->setPixmap(pm);
                ptr->setScaledContents(true);
...
{
    QPdfWriter pdf("C:/Users/hamza/Documents/AtelierCRUD/Liste.pdf");
    QPainter painter(&pdf);
    int i = 4000;
    painter.setPen(Qt::black);
    painter.setFont(QFont("Arial", 20));
    painter.drawPixmap(QRect(100,400,2000,2000),QPixmap("C:/Users/hamza/Documents/AtelierCRUD/images/310432895_2325982227549440_2476852675195435336_n.png"));
    ...
    {
        QDesktopServices::openUrl(QUrl::fromLocalFile("C:/Users/hamza/Documents/AtelierCRUD/Liste.pdf"));
        painter.end();
    }
